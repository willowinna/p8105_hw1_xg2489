...
This dataset contains 8 variables including species (Adelie, Chinstrap
and Gentoo), island, bill length(mm), bill depth(mm), flipper
length(mm), body mass(g), sex and year. The size of the dataset is 344
rows and 8 columns. The mean flipper length is 200.92 mm.
